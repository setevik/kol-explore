# ✅ RUN COMPLETE — Ascension #3 (Seal Clubber, WON on 2026-09-21)

> Beat the Naughty Sorceress + freed King Ralph XI on **Day 25**, then spent Day 26 on optional content and
> ascended **Softcore/Normal** into a **Turtle Tamer** run (Platypus sign, **Unrestricted** path).
> Arrived with a **213 karma balance** (102 banked + **111** for the Normal win — ✅ verified in-game: the
> charpane read 102 → 213 on collecting) and spent **210**: softcore-permed
> **Double-Fisted Skull Smashing** (100) + **Lunging Thrust-Smack** (100) + an **astral shield** (10);
> **3 karma banked**.
> Ran 2026-08-28 → 2026-09-22 (26 days), finishing at **Level 15**, base Muscle 273, 19,969 meat
> (all of it, plus the whole inventory, left in Hagnk's for run #4).
>
> 🎓 **Purpose achieved: the Seal Clubber is fully documented.** The guild rack was bought out to the last
> skill (Torg reported 0 remaining), and `mechanics/seal-clubber-class.md` now covers Fury, the priced ladder,
> what every top-tier skill actually does, the Nemesis route and the tower.
> ❌ **Left unfinished: Me and My Nemesis.** Its gate (an assassin ladder) opened on the final day, but the
> lair task — hellseal pups and mothers in the volcano lair — was never run. A future Seal Clubber run should
> pick it up from `mechanics/nemesis-quest.md` steps 7–8.
>
> Frozen final-state record of the THIRD run. Live state for the current run is in `../CURRENT_ASCENSION.md`.
