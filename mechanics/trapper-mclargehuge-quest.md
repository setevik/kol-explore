...
- Ore: equip **Mining Gear outfit** (`inv_equip.php?action=outfit&whichoutfit=8`), adventure **Itznotyerzitz
  Mine (270)**, dig via `mining.php?mine=1&which=<sq>` (~1 adv/dig; also yields diamonds ≈ meat).
...
- **With the outfit equipped, a chain of 3 noncombats unlocks the summit:** *Discovering Your Extremity*
  (guaranteed on the 1st slope turn) → *2 eXXtreme 4 U* → *3 eXXXtreme 4ever 6pack* (ours fired at slope
